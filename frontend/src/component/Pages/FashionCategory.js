...
const FashionCategory = () => {
    ...
    useEffect(() => {
        setLoading(true)
      axios.get('http://localhost:5000/api/fashioncategory').then(res=> {
        setLoading(false)
  ...
  return (
    <div>
        ...
        <div className="h-96 bg-gray-900 flex justify-center items-center fashion_bg bg-center">
            <h1 className="text-gray-100 text-4xl tracking-widest font-medium md:mx-0 mx-7">Fashion Category</h1>
        </div>
